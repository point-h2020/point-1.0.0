...
int GlobalConf::configure(Vector<String> &conf, ErrorHandler *errh) {
	...
	pathMgmtIID = String();
	AppnotificationScope = String();
	AppnotificationIID = String();
