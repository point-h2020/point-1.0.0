...
public:
     ...
     */
    bool storeActiveNode(String &_isubscriberID);
    ...
    /**@brief  Handles notifications published by apps to blackadder using NODE_LOCAL strategy.
     * currently only used for management notifications published by the LinkStateMonitor to inform blackadder of node disconnect/reconnect states (i.e. isolation/reconnection to the network)
     */
    void handleAppNotification(String &ID, Packet *p, LocalHost *_localhost);
