...
public:
    ...
    /** @brief array of booleans that defines the node type: FW,RV,TM according to NODE_TYPEs in enumerations.hh
     *
     */
    bool type[NUM_TYPEs];
	...
	/**@brief the Scope identifier to which this Blackadder node (the LocalProxy) will subscribe to receive all App-level notifications on NODE_LOCAL strategy.
	 *
	 * It is hardcoded to be the /FFFFFFFFFFFFFFF8.
	 *
	 * Note that the node label is the same size as the information labels (see helper.hh).
	 */
	String AppnotificationScope;
	/**@brief the Information identifier to which this Blackadder node (the LocalProxy) will subscribe to receive all App-level notifications on NODE_LOCAL strategy.
	 *
	 * It is hardcoded to be the /FFFFFFFFFFFFFFF8/FFFFFFFFFFFFFFF8.
	 *
	 * Note that the node label is the same size as the information labels (see helper.hh).
	 */
	String AppnotificationIID;
